...
#else
#define MOD_PSG_BUF_LENGTH %PSG_BUF_LENGTH
extern int cpu_time_of_last_sound_vbl ;
#endif
...
extern EasyStr sound_device_name; // INIT("/dev/dsp");
