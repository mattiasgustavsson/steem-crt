...
#else
extern int LoadSaveAllStuff(FILE *,bool,int=-1,bool=true,int * =NULL);
#endif
...
void LoadState(TConfigStoreFile *);
void SaveState(TConfigStoreFile *);
...
void LoadSnapShotChangeCart(Str);
void LoadSnapShotChangeDisks(Str[2],Str[2],Str[2]);
