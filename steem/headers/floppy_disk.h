...
enum EDiskImage { 
  ...
  FLOPPY_MAX_TRACK_NUM=85,
  FLOPPY_MAX_SECTOR_NUM=26, 
  // extensions
  EXT_ST=1,EXT_MSA,EXT_DIM,EXT_STT,EXT_STX,EXT_IPF,EXT_CTR,EXT_STG,EXT_STW,
  EXT_PRG,EXT_TOS,EXT_SCP,EXT_HFE,NUM_EXT,
  // image types
  ...
  MNGR_STEEM=1,MNGR_PASTI,MNGR_CAPS,MNGR_WD1772,MNGR_PRG
};
...
struct TFloppyDisk { // FloppyDisk[] objects inserted in FloppyDrive[] objects
  ...
  BYTE GetIDFields(int Side,int Track,TWD1772IDField *IDList);
