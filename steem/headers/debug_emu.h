...
extern void debug_update_cycle_counts();
extern void debug_update_drawing_position(int* =(NULL));
extern void update_display_after_trace();
...
extern int debug_time_to_timer_timeout[4];
#if defined(SSE_DEBUGGER_DECRYPT_TIMERS)
extern int debug_time_to_timer_prescale[4];
extern int debug_time_to_timer_data[4];
extern int debug_time_to_timer_count[4];
extern int debug_time_to_timer_ticks[4];
#endif
#if defined(SSE_DEBUGGER_FRAME_INTERRUPTS)
extern DWORD debug_frame_interrupts;
#endif
extern void debug_check_for_events();
extern void iolist_debug_add_pseudo_addresses();
...
extern void debug_hit_mon(MEM_ADDRESS,int);
extern void debug_hit_io_mon_write(MEM_ADDRESS,int);
