...
void macro_record_mouse(int,int);
void macro_record_key(BYTE);

bool macro_play_start();
void macro_play_joy();
void macro_play_mouse(int&,int&);
...
bool macro_mvi_blank(TMacroVblInfo *);
void macro_file_options(int,char*,TMacroFileOptions *,FILE* = NULL);
